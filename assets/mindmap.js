...
(function () {
  ...
  var C_ACCENT = theme("--indigo", "#B0562C");        // session fill + trunk
  var C_DEEP   = theme("--indigo-deep", "#2A4030");   // root fill
  var C_SOFT   = theme("--indigo-soft", "#C3D6C7");   // concept border
  var C_TINT   = theme("--indigo-50", "#EDF3EE");     // concept fill
  var C_INK    = theme("--ink", "#1F2A22");           // concept text
  var C_FAINT  = theme("--faint", "#D3DCD4");         // twig edges
